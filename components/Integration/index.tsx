...
const Integration = () => {
  ...
  <SectionHeader
    headerInfo={{
      ...
      subtitle: `Seamless Integration for Enhanced Efficiency and Accessibility.`,
      description: `Discover how Lumiora's automation integrations enable remote data management and accessibility, empowering your business anytime, anywhere.`,
    }}
  />
  {/* <!-- Section Title End --> */}
</div>
